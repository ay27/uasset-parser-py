...
# from Engine/Source/Core/Public/UObject/ObjectVersion.h
...
class EUnrealEngineObjectUE4Version(IntEnum):
    ...
    # Rename USpringArmComponent::bUseControllerViewRotation to bUsePawnViewRotation = auto()
...
UE5Versions = EUnrealEngineObjectUE5Version
